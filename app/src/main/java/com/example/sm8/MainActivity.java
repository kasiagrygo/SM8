...
import com.example.sm8.databinding.ActivityMainBinding;
...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onActivityResult(int requestCode, int resultCode, @Nullable Intent data) {
        ...
        if (requestCode == NEW_BOOK_ACTIVITY_REQUEST_CODE) {
            ...
            if (resultCode == RESULT_OK && editedBook != null) {
                String editedTitle = data.getStringExtra(EditBookActivity.EXTRA_EDIT_BOOK_TITLE);
                String editedAuthor = data.getStringExtra(EditBookActivity.EXTRA_EDIT_BOOK_AUTHOR);
